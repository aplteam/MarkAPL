...
1. If a list follows a paragraph no blank line is needed between the paragraph and the list.
   ...
   Watch out, this can backfire: if a line within a paragraph happens to start with a number then this **starts a list**!
...
This document refers to version 4.4.1 of **_MarkAPL_**.

Kai Jaeger ⋄ APL Team Ltd ⋄ 2018-03-07
